...
<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
    ...
    <div class="brand flex-column-auto" id="kt_brand">
        ...
        <a href="/" class="brand-logo">
            <img alt="Logo" src="{{asset('backend-assets/assets/media/logos/lu-routine-logo.png')}}" />
        </a>
                                    ...
                                    <ul class="menu-subnav">
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{route('room.index')}}" class="menu-link">
                                                ...
                                                <span class="menu-text">See Rooms</span>
                                            </a>
                                        </li>
                                        <li class="menu-item" aria-haspopup="true">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                <a href="javascript:;" class="menu-link menu-toggle">
                                    ...
                                    <span class="menu-text">Days</span>
                                    <span class="menu-label">
                                    </span>
                                    <i class="menu-arrow"></i>
                                </a>
                                    ...
                                    <ul class="menu-subnav">
                                        ...
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                            ...
                                            <a href="javascript:;" class="menu-link menu-toggle">
                                                ...
                                                <span class="menu-text">Sunday</span>
                                                <span class="menu-label">
                                                </span>
                                                <i class="menu-arrow"></i>
                                            </a>
                                            <div class="menu-submenu">
                                                ...
                                                <ul class="menu-subnav">
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{route('sunday.index')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
                                                                <span></span>
                                                            </i>
                                                            <span class="menu-text">View Sunday</span>
                                                        </a>
                                                    </li>
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{route('sunday.create')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
                                                                <span></span>
                                                            </i>
                                                            <span class="menu-text">Add Sunday Data</span>
                                                        </a>
                                                    </li>
                                                </ul>
                                            </div>
                                        ...
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                            ...
                                            <a href="javascript:;" class="menu-link menu-toggle">
                                                ...
                                                <span class="menu-text">Monday</span>
                                                <span class="menu-label">
                                                </span>
                                                <i class="menu-arrow"></i>
                                            </a>
                                                ...
                                                <ul class="menu-subnav">
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{route('monday.index')}}" class="menu-link">
                                                            ...
                                                            <span class="menu-text">View Monday</span>
                                                        </a>
                                                    </li>
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{route('monday.create')}}" class="menu-link">
                                                            ...
                                                            <span class="menu-text">Add Monday Data</span>
                                                        </a>
                                                    </li>
                                                </ul>
                                            </div>
										...
										<li class="menu-item menu-item-submenu" aria-haspopup="true"
                                            ...
                                            <a href="javascript:;" class="menu-link menu-toggle">
                                                ...
                                                <span class="menu-text">Tuesday</span>
                                                <span class="menu-label">
                                                </span>
                                                <i class="menu-arrow"></i>
                                            </a>
                                                ...
                                                <ul class="menu-subnav">
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{route('tuesday.index')}}" class="menu-link">
                                                            ...
                                                            <span class="menu-text">View Tuesday</span>
                                                        </a>
                                                    </li>
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{route('tuesday.create')}}" class="menu-link">
                                                            ...
                                                            <span class="menu-text">Add Tuesday Data</span>
                                                        </a>
                                                    </li>
                                                </ul>
                                            </div>
                                                ...
                                                <ul class="menu-subnav">
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{route('wednesday.index')}}" class="menu-link">
                                                            ...
                                                            <span class="menu-text">View Wednesday</span>
                                                        </a>
                                                    </li>
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{route('wednesday.create')}}" class="menu-link">
                                                            ...
                                                            <span class="menu-text">Add Wednesday Data</span>
                                                        </a>
                                                    </li>
                                                </ul>
                                            </div>
										...
										<li class="menu-item menu-item-submenu" aria-haspopup="true"
                                            ...
                                            <a href="javascript:;" class="menu-link menu-toggle">
                                                ...
                                                <span class="menu-text">Thursday</span>
                                                <span class="menu-label">
                                                </span>
                                                <i class="menu-arrow"></i>
                                            </a>
                                                ...
                                                <ul class="menu-subnav">
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{route('thursday.index')}}" class="menu-link">
                                                            ...
                                                            <span class="menu-text">View Thursday</span>
                                                        </a>
                                                    </li>
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{route('thursday.create')}}" class="menu-link">
                                                            ...
                                                            <span class="menu-text">Add Thursday Data</span>
                                                        </a>
                                                    </li>
                                                </ul>
                                            </div>
										...
										<li class="menu-item menu-item-submenu" aria-haspopup="true"
                                            ...
                                            <a href="javascript:;" class="menu-link menu-toggle">
                                                ...
                                                <span class="menu-text">Friday</span>
                                                <span class="menu-label">
                                                </span>
                                                <i class="menu-arrow"></i>
                                            </a>
                                                ...
                                                <ul class="menu-subnav">
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{route('friday.index')}}" class="menu-link">
                                                            ...
                                                            <span class="menu-text">View Friday</span>
                                                        </a>
                                                    </li>
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{route('friday.create')}}" class="menu-link">
                                                            ...
                                                            <span class="menu-text">Add Friday Data</span>
                                                        </a>
                                                    </li>
                                                </ul>
                                            </div>
										...
										<li class="menu-item menu-item-submenu" aria-haspopup="true"
                                            ...
                                            <a href="javascript:;" class="menu-link menu-toggle">
                                                ...
                                                <span class="menu-text">Saturday</span>
                                                <span class="menu-label">
                                                </span>
                                                <i class="menu-arrow"></i>
                                            </a>
                                                ...
                                                <ul class="menu-subnav">
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{route('saturday.index')}}" class="menu-link">
                                                            ...
                                                            <span class="menu-text">View Saturday</span>
                                                        </a>
                                                    </li>
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{route('saturday.create')}}" class="menu-link">
                                                            ...
                                                            <span class="menu-text">Add Saturday Data</span>
                                                        </a>
                                                    </li>
                                                </ul>
                                            </div>
                            ...
                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                <a href="javascript:;" class="menu-link menu-toggle">
                                    ...
                                    <span class="menu-text">All Previous Routine</span>
                                    <span class="menu-label">
                                    </span>
                                    <i class="menu-arrow"></i>
                                </a>
                                    ...
                                    <ul class="menu-subnav">
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{route('teacher.index')}}" class="menu-link">
                                                ...
                                                <span class="menu-text">See List</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
