...
<div class="col-xl-12">
    ...
    <table class="table table-bordered border-primary">
        ...
        <tbody>
            ...
            <tr>
                @if ($row == 0 || $row % 12 == 0)
                <th rowspan="12" style="writing-mode: vertical-rl; text-orientation: upright; text-align:center">Monday
                </th>
                @endif
                <td>{{$data->section}}</td>
                <td>{{$data->batch}}</td>
                ...
                <td>
                    <a class=" btn-bg-dark" href="{{route('monday.edit',[$data->id])}}"> <button type="button"
                            class="btn btn-info btn-sm">Edit</button>
                    </a>
                    <a href="{{route('monday.delete',[$data->id])}}">
