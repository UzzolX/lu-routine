...
<table class="table table-bordered border-primary">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a class=" btn-bg-dark" href="{{route('friday.edit',[$data->id])}}"> <button type="button"
                        class="btn btn-info btn-sm">Edit</button>
                </a>
                <a href="{{route('friday.delete',[$data->id])}}">
